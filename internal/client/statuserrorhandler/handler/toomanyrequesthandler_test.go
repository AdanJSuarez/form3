...
func (ts *TSTooManyRequestHandler) TestTooManyRequestsResponseReturnsErrorCorrectly() {
...
func (ts *TSTooManyRequestHandler) TestNotTooManyRequestResponseReturnsUncoveredError() {
