...
func (ts *TSError) TestTypeDescriptionError() {
...
func (ts *TSError) TestNotValidTypeDescriptionError() {
	err := newTypeDescriptionError(777, invalidBody)
	ts.ErrorContains(err, "status code 777:")
	ts.NotContains(err.Error(), "errorDescription:")
}

func (ts *TSError) TestCodeMessageError() {
...
func (ts *TSError) TestInvalidCodeMessageError() {
