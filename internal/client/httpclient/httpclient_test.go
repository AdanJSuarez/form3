...
func (ts *TSHTTPClient) TestSendValidRequestReturnsNoError() {
...
func (ts *TSHTTPClient) TestSendInvalidRequestReturnsError() {
	mockHTTPClient.On("Do", mock.Anything).Return(nil, fmt.Errorf("fakeError"))
	response, err := httpClientTest.SendRequest(requestTest)
	ts.ErrorContains(err, "fakeError")
	ts.Nil(response)
}
func (ts *TSHTTPClient) TestSendRequestReturnsTimeoutErrorAfterRetry() {
...
func (ts *TSHTTPClient) TestSendNilRequestsReturnError() {
	response, err := httpClientTest.SendRequest(nil)
	ts.ErrorContains(err, "nil request")
	ts.Nil(response)
}

func (ts *TSHTTPClient) TestSendRequestReturnsResponseNotFound() {
...
func (ts *TSHTTPClient) TestSendRequestReturnsTooManyRequestAfterRetry() {
...
func (ts *TSHTTPClient) TestSendRequestReturnsInternalServerErrorAfterRetry() {
	mockHTTPClient = new(mockHttpClient)
	httpClientTest.httpClient = mockHTTPClient
...
func (ts *TSHTTPClient) TestSendRequestReturnsBadGatewayErrorAfterRetry() {
	mockHTTPClient = new(mockHttpClient)
	httpClientTest.httpClient = mockHTTPClient
...
func (ts *TSHTTPClient) TestSendRequestReturnsServiceUnavailableErrorAfterRetry() {
	mockHTTPClient = new(mockHttpClient)
	httpClientTest.httpClient = mockHTTPClient
...
func (ts *TSHTTPClient) TestSendRequestReturnsGatewayTimeoutErrorAfterRetry() {
	mockHTTPClient = new(mockHttpClient)
	httpClientTest.httpClient = mockHTTPClient
